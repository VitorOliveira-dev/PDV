...
public class PDVController {
    ...
    public static String[] vendaBuscarProduto(String codigo, String instrumento) {
    ...
    /*testeteteteet*/
        ...
        public static ArrayList<String[]> TvendaBuscarProduto(String pCodigo, String pInstrumento) {
        
        ArrayList<Produto> listaProdutos = PDVDAO.TvendaBuscarProduto(pCodigo, pInstrumento);
        ArrayList<String[]> retorno = new ArrayList<>();
